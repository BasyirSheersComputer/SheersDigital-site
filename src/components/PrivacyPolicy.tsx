          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Sheers Digital Sdn. Bhd. (Company No. 1234567-X) ("we," "our," or "us") is committed to protecting your privacy and personal data in accordance with the Personal Data Protection Act 2010 (PDPA) of Malaysia and other applicable laws.
              </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-700">privacy@sheerscomputer.my</span>
                  </div>
                  <div className="flex items-center space-x-2">
