      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <AnimatedSection animation="slideRight" delay={0.7}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <AnimatedSection key={index} animation="slideLeft" delay={0.3 + (0.1 * index)}>
                <div className="bg-slate-700 rounded-xl p-6 hover:bg-slate-600 transition-colors duration-300">
