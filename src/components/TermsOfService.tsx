          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                These Terms of Service ("Terms") constitute a legally binding agreement between you and Sheers Digital Sdn. Bhd. (Company No. 1234567-X) ("Company," "we," "our," or "us") regarding your use of our website and services.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">Sheers Digital provides IT project management services including but not limited to:</p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="text-green-700">
                  ...
                  Address: Level 1, Villa Putra, Jalan Sultan Ismail, Kuala Lumpur 50480, Malaysia
                </div>
              </div>
            </section>
